...
GRADIENT_CODES=("1;38;5;160" "1;38;5;166" "1;38;5;172" "1;38;5;178" "1;38;5;184" "1;38;5;220")
...
echo "1. Describe the task in plain English."
echo "2. Be specific about paths, sizes, or filters."
echo "3. Type 'exit' or 'quit' to stop."
echo "$(dim "Python ${PY_VERSION} | venv: ${VENV_LABEL} | ${PROJECT_NAME}")"

read_prompt() {
  local placeholder="Describe a task"
  local first=""
  local rest=""

  if [[ ! -t 0 ]]; then
    IFS= read -r PROMPT || return 1
    return 0
  fi
